...
const CardOne = ({ product, adminPage = false, homePage = false }) => {
    ...
    return (
        <>
            <div style={{ width: "18rem", height: "25rem" }} class="max-w-sm m-4 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <img style={{ width: "100%", height: "200px" }} class="rounded-t-lg" src={`/uploads/${product.fileName}`} alt="" />
                <div className="p-3">
